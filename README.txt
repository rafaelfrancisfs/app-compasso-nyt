...
INSTRUÇÕES:
    - Para executar o projeto no smartphone é necessário usar o aplicativo EXPO;
    - Execute via terminal yarn start ou npm start;
    - Lei o QRCode com a camera de smartphone;
    - Abra via EXPO;
